    ...
    >
      ...
      >
        ...
        <div
          ref={cakeRef}
          data-no-burst="true"
          className="animate-bounce-slow delay-100 mb-4 select-none"
        ...
        {/* sparkle divider */}
        <div className="animate-fadeInUp delay-700 flex items-center gap-3 mt-8 mb-6">
      ...
      >
        ...
        <button
          onClick={onNext}
          className="btn-primary btn-gold animate-pulse-glow mt-10"
